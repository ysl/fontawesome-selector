...
(function ($, icons, webChef) {
  ...
  var iconModalTemplate =
    ...
    '<select id ="tx-icon-size" placeholder="Icon Size" class="form-control pull-right">' +
  ...
  var generateIconsList = function (icons) {
    ...
    var list = $.map(icons, function (icon) {
      ...
      return webChef.cook(iconLiTemplate, {'icon': icon, active: active ? 'active' : ""});
    });
